            ...
            <div class="con_wrap">
                <div class="content_box">
                    <div class="subtit_wrap">
                        <p>브랜드 스토리</p>
                        <ul>
                            <li class="on"><a href="../story">버거킹 스토리</a></li>
                    ...
                    <div class="story_box1 box1 show">
                        <div class="about">
                            <img src="resources/img/stroy/img_story01.33f0084e.jpg" alt="스토리사진1">
                            <h3>GLOBAL 버거킹</h3>
                        ...
                        <div class="about">
                            <img src="resources/img/stroy/img_story02.0e5ce49b.jpg" alt="스토리사진2">
                            <h3>버거킹 KOREA</h3>
