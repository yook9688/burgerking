...
.product_name {color:#fff; font-size:50px; margin: 0; line-height: 400px;}
...
.product_btn {color:#fff; font-size:24px; font-weight: bold; border: 0; background: transparent;}
.product_info_box {max-width: 1144px;; height: 400px; margin: 0 auto;}
.product_info_box p { margin: 60px 0; font-size: 20px;}
</style>
<script>
        ...
        <div id="content">
            <div class="site_locate">
                <div class="locate_box">
                    <a href="/">Home</a>
                    <a href="prolist?cate=${product.pCategory }">메뉴소개</a>
