	...
	<script type="text/javascript">
		...
		<div id="content">
			...
			<div class="con_wrap">
				...
				<div class="con_box">
					<form class="update_form" action="/member/update" method="post">
						<div>
							<label for="userId">아이디</label>
							<input class="update_input" type="text" id="userId" name="userId" value="${member.userId}" readonly />
						</div>
						<div>
						...
						<div>
							...
							<input class="update_input" type="text" id="userName" name="userName" value="${member.userName}" />
						</div>
						<div>
							<label for="userBirth">생년월일</label>
							<input class="update_input" type="date" id="userBirth" name="userBirth" value="${member.userBirth}" />
						</div>
						<div>
							<label for="userEmail">이메일</label>
							<input class="update_input" type="email" id="userEmail" name="userEmail" value="${member.userEmail}" />
						</div>
						<div>
							<label for="userAddress">주소</label> 
							<input class="update_input" type="text" id="userAddress" name="userAddress" value="${member.userAddress}" readonly onclick="execDaumPostcode();" />
						</div>
						<div>
							<label for="userdetailAddress">상세주소</label> 
							<input class="update_detailAddress" type="text" id="userDetailAddress" name="userDetailAddress" value="${member.userDetailAddress}" />
							<input class="update_extraAddress" type="text" id="userExtraAddress" name="userExtraAddress" value="${member.userExtraAddress}" readonly />
						</div>
						...
						<div>
							...
							<input class="update_input" type="text" id="userPhone" name="userPhone" value="${member.userPhone }" />
						</div>
