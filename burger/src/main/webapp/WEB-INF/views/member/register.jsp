...
<div id="content">
	<div class="site_locate">
		<div class="locate_box">
			<a href="/">Home</a> <a href="../member/loginView">로그인</a> <span>회원가입</span>
		</div>
	</div>
	<div class="con_wrap">
		<h2 class="con_tit">회원가입</h2>
		<div class="con_box">
			<form class="register_form" action="/member/register" method="post">
				<div>
				...
				<div>
					<label for="userBirth">생년월일</label> <input class="register_input"
						type="date" id="userBirth" name="userBirth" min="1900-01-01" />
				</div>
				<div>
					<label for="userEmail">이메일</label> <input class="register_input"
